...
namespace FS.ADIM.OA.MOSSS
{
    ...
    {
        #region 变量定义
        private const string logPath = @"D:\Adim\OA.WebUI\Log";

        private static string swdUrl = string.Empty;//站点+库
        private static string fullUrl = string.Empty; //全路径


        private static string docLibUrlName = string.Empty; //文档库英文名 doc
        private static string docLibUrlNameNew = string.Empty; //文档库英文名 doc


        private static string siteUrl = string.Empty; //站点地址
        private static string webUrl = string.Empty; //网站地址
        private static string docLibName = string.Empty; //文档库中文名 公司发文
        private static string folderUrlName = string.Empty; //文件夹路径   1/2  1
        private static string fileName = string.Empty; //文件名

        private static string siteUrlNew = string.Empty; //站点地址
        private static string webUrlNew = string.Empty; //网站地址
        private static string docLibNameNew = string.Empty; //文档库中文名 公司发文
        private static string folderUrlNameNew = string.Empty; //文件夹路径   1/2  1
        private static string fileNameNew = string.Empty; //文件名

        private static string foliName = string.Empty; //文件夹+文件名

        #endregion

        #region 验证文件是否上传成功
        public static int CheckHave(string[] fileInfo)
        {
            SetUrl(fileInfo);
            int index = 0;
        ...
        public static string[] Upload(string[] fileInfo, byte[] bStream, DictionaryEntry[] deMeta, bool overwrite)
        {
            try
            {
                SetUrl(fileInfo);
        ...
        /// <returns>1.全地址 2.文件夹+文件名</returns>
        //fileInfo=1.站点url 2.文档库名 3.文件夹 4.文件
        public static string[] Upload(string[] fileInfo, string TempFilePath, DictionaryEntry[] deMeta, bool overwrite)
        {
            try
            {
                SetUrl(fileInfo);
        ...
        /// <returns></returns>
        //fileInfo=1.站点url 2.文档库名 3.文件夹 4.文件
        public static byte[] Download(string[] fileInfo)
        {
            try
            {
                byte[] bStream = null;
        ...
        /// <returns></returns>
        //fileInfo=1.站点url 2.文档库名 3.文件夹 4.文件
        public static string Download_New(string[] fileInfo, string TempFileName)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                string contents = DateTime.Now.ToString() + "：" + ex.Message + " " + fullUrl;
                contents += "\r\n fileInfo[0]=" + fileInfo[0] + " fileInfo[1]=" + fileInfo[1] + " fileInfo[2]=" + fileInfo[2] + " fileInfo[3]=" + fileInfo[3];
                System.IO.File.AppendAllText(dirPath + fileName, contents, System.Text.Encoding.UTF8);
        ...
        /// <param name="fileInfo"></param>
        /// <returns></returns>
        public static long FileLength(string[] fileInfo)
        {
            try
            {
                long fileLength = 0;
        ...
        /// <param name="fileInfo"></param>
        /// <returns></returns>
        public static int CheckIn(string[] fileInfo)
        {
            try
            {
                SetUrl(fileInfo);
        ...
        /// <param name="fileInfo"></param>
        /// <returns></returns>
        public static int CheckOut(string[] fileInfo)
        {
            try
            {
                SetUrl(fileInfo);
        ...
        /// <param name="fileInfo"></param>
        /// <returns></returns>
        public static int UndoCheckOut(string[] fileInfo)
        {
            try
            {
                SetUrl(fileInfo);
        ...
        #region 删除
        public static int Remove(string[] fileInfo)
        {
        ...
        /// <param name="fileInfo"></param>
        /// <returns></returns>
        public static int Remove(string[] fileInfo, bool isTrueDel)
        {
            try
            {
                SetUrl(fileInfo);
        ...
        /// <returns></returns>
        public static string[] CopyToNew(string[] fileInfo, string[] newFileInfo, bool overwrite)
        {
            try
            {
                SetUrl(fileInfo);
        ...
        /// <param name="overwrite"></param>
        /// <returns></returns>
        public static string[] CopyTo(string[] fileInfo, string newFileName, bool overwrite)
        {
            try
            {
                SetUrl(fileInfo);
        ...
        private static void SetUrl(string[] fileInfo)//网站+站点
        {
        ...
        private static void SetUrlNew(string[] fileInfo)//网站+站点
        {
        ...
        /// <param name="entries"></param>
        /// <returns></returns>
        private static Hashtable ConvertToHT(DictionaryEntry[] entries)
        {
        ...
        #region CAML语句查文件
        private static SPListItem GetSPItem(SPList list)
        {
        ...
        private static SPQuery GetSPQuery(SPList list)
        {
        ...
        private static SPFolder GetSubFolders(SPList list, string sfolder)
        {
            if (sfolder.Length > 0)
            {
                //如果字符串
        ...
        private static int GetFileIndex(SPListItemCollection itemColl, string fileName)
        {
        ...
        private static void CheckSPWeb()
        {

        }
        private static void CheckWebList(SPWeb web, string name)
        {
            bool IsExist = false;
        ...
        private static void CheckListField(SPList list, Hashtable ht)
        {
        ...
        /// </summary>
        /// <returns></returns>
        private static string GetFileName_New()
        {

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PG_CommentInfo.aspx.cs"
    Inherits="FS.ADIM.OA.WebUI.WorkFlow.ProgramFile.PG_CommentInfo" %>
...
<body>
    ...
    <div style="font-size: 13px">
        <table style="border-top: none; border: solid 1px #EAEAEA; width: 100%">
            <tr style="color: #333; font-size: 12px; font-weight: bold; background: #deeef4;
                height: 25px">
                <td style="width: 30px;">
                    序号
                </td>

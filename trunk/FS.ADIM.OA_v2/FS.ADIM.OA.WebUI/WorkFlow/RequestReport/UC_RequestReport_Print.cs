...
namespace FS.ADIM.OA.WebUI.WorkFlow.RequestReport
{
    public partial class UC_RequestReport
    {
        ...
        private B_RequestReport m_Entity = null;
        ...
        {
            //B_RequestReport cEntity = this.ControlToEntity(false) as B_RequestReport;
            B_RequestReport cEntity = null;
            if (base.IsPreview)
            {
                cEntity = base.EntityData != null ? base.EntityData as B_RequestReport : new B_RequestReport();
            }
            else
            {
                cEntity = this.ControlToEntity(false) as B_RequestReport;
            }
        ...
        private void ucPrint_OnAttachExport(object sender, EventArgs e)
        {
            ...
            //B_RequestReport cEntity = new B_RequestReport();
        ...
        private void Print_OnBeginExport(object sender, EventArgs e)
        {
            ...
            m_Entity = m_print.m_CurrEntity as B_RequestReport;

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UC_CommonWaitHandle.ascx.cs"
    Inherits="FS.ADIM.OA.WebUI.WorkflowMenu.ToDoTask.UC_CommonWaitHandle" %>
        ...
        <div style="width: 100%">
            <cc1:FSGridView ID="gvTaskList" runat="server" AllowPaging="True" AllowSorting="true"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="操作" HeaderStyle-Width="60px" ItemStyle-CssClass="td_Center">
                        <ItemTemplate>
                            <asp:Label ID="lblInfo" runat="server" Visible="false" Style="margin: 3px;"></asp:Label>
                            <asp:HyperLink ID="hlkHandle" runat="server" Text="处理任务" Visible="false" Style="margin: 3px;"></asp:HyperLink>
                            <asp:HyperLink ID="hlkView" runat="server" Text="查看任务" Visible="false" Style="margin: 3px;"></asp:HyperLink>
                            <asp:LinkButton ID="lbnRetrieve" runat="server" Text="获取任务" OnClick="lbnRetrieve_Click"
                                Visible="false" Style="margin: 3px;">
                            </asp:LinkButton>
                            <asp:LinkButton ID="lbnRestore" runat="server" Text="归还任务" OnClick="lbnRestore_Click"
                                Visible="false" Style="margin: 3px;">
                            </asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:BoundField DataField="Drafter" SortExpression="Drafter" HeaderText="发起人" HeaderStyle-Width="50px" Visible="false">
                    </asp:BoundField>
